...
#ifndef AURORA_COMPOSITOR_WAYLANDFLUIDDECORATIONV1_H
#define AURORA_COMPOSITOR_WAYLANDFLUIDDECORATIONV1_H
...
#endif // AURORA_COMPOSITOR_WAYLANDFLUIDDECORATIONV1_H
