...
#ifndef AURORA_COMPOSITOR_WAYLANDEXTSESSIONLOCKV1_P_H
#define AURORA_COMPOSITOR_WAYLANDEXTSESSIONLOCKV1_P_H
...
#endif // AURORA_COMPOSITOR_WAYLANDEXTSESSIONLOCKV1_P_H
