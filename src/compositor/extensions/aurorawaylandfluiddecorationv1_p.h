...
#ifndef AURORA_COMPOSITOR_WAYLANDFLUIDDECORATIONV1_P_H
#define AURORA_COMPOSITOR_WAYLANDFLUIDDECORATIONV1_P_H
...
#endif // AURORA_COMPOSITOR_WAYLANDFLUIDDECORATIONV1_P_H
