...
AURORA_COMPOSITOR_DECLARE_QUICK_EXTENSION_CONTAINER_CLASS(WaylandQuickCompositor)
AURORA_COMPOSITOR_DECLARE_QUICK_EXTENSION_CLASS(WaylandQtWindowManager)
AURORA_COMPOSITOR_DECLARE_QUICK_EXTENSION_CLASS(WaylandIdleInhibitManagerV1)
AURORA_COMPOSITOR_DECLARE_QUICK_EXTENSION_CLASS(WaylandTextInputManager)
