...
if(FEATURE_aurora_xkbcommon)
    ...
    if(NOT TARGET XkbCommon::XkbCommon)
        message(STATUS "You need xkbcommon for Aurora::XkbCommon")
...
if(FEATURE_aurora_brcm)
    ...
    if(NOT TARGET EGL::EGL)
        message(STATUS "You need EGL for Aurora::Brcm")
...
if(FEATURE_aurora_brcm)
    ...
    if(NOT TEST_egl_brcm)
        message(STATUS "You need egl-brcm for Aurora::Brcm")
        set(FEATURE_aurora_brcm OFF)
    endif()
endif()
...
if(FEATURE_aurora_compositor_quick)
    if(NOT TARGET Qt6::Quick)
        message(STATUS "You need Qt Quick for Aurora::WaylandCompositorQuick")
...
if(FEATURE_aurora_dmabuf_client_buffer)
    ...
    if(NOT TARGET EGL::EGL)
        message(STATUS "You need EGL for Aurora::DmabufClientBuffer")
        set(FEATURE_aurora_dmabuf_client_buffer OFF)
    endif()
    if(NOT TARGET PkgConfig::Libdrm)
        message(STATUS "You need libdrm for Aurora::DmabufClientBuffer")
        set(FEATURE_aurora_dmabuf_client_buffer OFF)
    endif()
    if(NOT TARGET Qt6::OpenGL)
        message(STATUS "You need Qt OpenGL for Aurora::DmabufClientBuffer")
        set(FEATURE_aurora_dmabuf_client_buffer OFF)
    endif()
endif()
if(FEATURE_aurora_dmabuf_client_buffer)
    ...
    if(NOT TEST_dmabuf_client_buffer)
        message(STATUS "You need EGL_LINUX_DMA_BUF_EXT for Aurora::DmabufClientBuffer")
        set(FEATURE_aurora_dmabuf_client_buffer OFF)
    endif()
endif()
...
if(FEATURE_aurora_dmabuf_server_buffer)
    ...
    find_package(Libdrm QUIET)
    if(NOT TARGET EGL::EGL)
        message(STATUS "You need EGL for Aurora::DmabufServerBuffer")
        set(FEATURE_aurora_dmabuf_server_buffer OFF)
    endif()
    if(NOT TARGET PkgConfig::Libdrm)
        message(STATUS "You need libdrm for Aurora::DmabufServerBuffer")
        set(FEATURE_aurora_dmabuf_server_buffer OFF)
    endif()
    if(NOT TARGET Qt6::OpenGL)
        message(STATUS "You need Qt OpenGL for Aurora::DmabufServerBuffer")
        set(FEATURE_aurora_dmabuf_server_buffer OFF)
    endif()
endif()
if(FEATURE_aurora_dmabuf_server_buffer)
    ...
    if(NOT TEST_dmabuf_server_buffer)
        message(STATUS "You need EGL_LINUX_DMA_BUF_EXT for Aurora::DmabufServerBuffer")
        set(FEATURE_aurora_dmabuf_server_buffer OFF)
    endif()
endif()
...
if(FEATURE_aurora_drm_egl_server_buffer)
    find_package(EGL QUIET)
    if(NOT TARGET EGL::EGL)
        message(STATUS "You need EGL for Aurora::DrmEglServerBuffer")
...
if(FEATURE_aurora_drm_egl_server_buffer)
    ...
    if(NOT TEST_drm_egl_server)
        message(STATUS "You need EGL_MESA_drm_image for Aurora::DmabufServerBuffer")
        set(FEATURE_aurora_drm_egl_server_buffer OFF)
    endif()
endif()
...
if(FEATURE_aurora_wayland_egl)
    ...
    if(NOT TARGET EGL::EGL)
        message(STATUS "You need EGL for Aurora::WaylandEgl")
        set(FEATURE_aurora_wayland_egl OFF)
    endif()
    if(NOT TARGET Wayland::Egl)
        message(STATUS "You need libdrm for Aurora::WaylandEgl")
        set(FEATURE_aurora_wayland_egl OFF)
    endif()
    if(NOT TARGET Qt6::OpenGL)
        message(STATUS "You need Qt OpenGL for Aurora::WaylandEgl")
        set(FEATURE_aurora_wayland_egl OFF)
    endif()
endif()
...
if(FEATURE_aurora_libhybris_egl_server_buffer)
    find_package(EGL QUIET)
    if(NOT TARGET EGL::EGL)
        message(STATUS "You need EGL for Aurora::LibhybrisEgl")
        set(FEATURE_aurora_libhybris_egl_server_buffer OFF)
    endif()
    if(NOT TARGET Qt6::OpenGL)
        message(STATUS "You need Qt OpenGL for Aurora::LibhybrisEgl")
        set(FEATURE_aurora_libhybris_egl_server_buffer OFF)
    endif()
endif()
if(FEATURE_aurora_libhybris_egl_server_buffer)
    ...
    if(NOT TEST_libhybris_egl_server)
        message(STATUS "You need EGL_HYBRIS_native_buffer for Aurora::LibhybrisEgl")
        set(FEATURE_aurora_libhybris_egl_server_buffer OFF)
    endif()
endif()
...
if(FEATURE_aurora_qpa)
    ...
    if(NOT TARGET EGL::EGL)
        message(STATUS "You need EGL for Aurora::QPA")
        set(FEATURE_aurora_qpa OFF)
    endif()
    if(NOT TARGET PkgConfig::Libudev)
        message(STATUS "You need udev for Aurora::QPA")
        set(FEATURE_aurora_qpa OFF)
    endif()
    if(NOT TARGET PkgConfig::Libinput)
        message(STATUS "You need libinput for Aurora::QPA")
        set(FEATURE_aurora_qpa OFF)
    endif()
    if(NOT TARGET PkgConfig::Libdrm)
        message(STATUS "You need libdrm for Aurora::QPA")
        set(FEATURE_aurora_qpa OFF)
    endif()
    if(NOT TARGET PkgConfig::Libxcvt)
        message(STATUS "You need libxcvt for Aurora::QPA")
        set(FEATURE_aurora_qpa OFF)
    endif()
    if(NOT TARGET PkgConfig::LibDisplayInfo)
        message(STATUS "You need libdisplay-info for Aurora::QPA")
        set(FEATURE_aurora_qpa OFF)
    endif()
    if(NOT TARGET PkgConfig::Gbm)
        message(STATUS "You need gbm for Aurora::QPA")
        set(FEATURE_aurora_qpa OFF)
    endif()
    if(NOT TARGET Fontconfig::Fontconfig)
        message(STATUS "You need fontconfig for Aurora::QPA")
        set(FEATURE_aurora_qpa OFF)
    endif()
    if(NOT FEATURE_aurora_xkbcommon)
        message(STATUS "You need XkbCommon support for Aurora::QPA")
        set(FEATURE_aurora_qpa OFF)
    endif()
endif()
...
if(FEATURE_aurora_shm_emulation_server)
    if(NOT TARGET Qt6::OpenGL)
        message(STATUS "You need Qt OpenGL for Aurora::ShmEmulationServer")
...
if(FEATURE_aurora_vulkan_server_buffer)
    ...
    if(NOT TARGET Qt6::OpenGL)
        message(STATUS "You need Qt OpenGL for Aurora::VulkanServerBuffer")
        set(FEATURE_aurora_vulkan_server_buffer OFF)
    endif()
    if(NOT TARGET PkgConfig::Vulkan)
        message(STATUS "You need Vulkan for Aurora::VulkanServerBuffer")
        set(FEATURE_aurora_vulkan_server_buffer OFF)
    endif()
endif()
if(FEATURE_aurora_vulkan_server_buffer)
...
if(FEATURE_aurora_deviceintegration_drm)
    ...
    if(NOT TARGET EGL::EGL)
        message(STATUS "You need EGL for Aurora::DeviceIntegration::DRM")
        set(FEATURE_aurora_deviceintegration_drm OFF)
    endif()
    if(NOT TARGET PkgConfig::Libudev)
        message(STATUS "You need udev for Aurora::DeviceIntegration::DRM")
        set(FEATURE_aurora_deviceintegration_drm OFF)
    endif()
    if(NOT TARGET PkgConfig::Libinput)
        message(STATUS "You need libinput for Aurora::DeviceIntegration::DRM")
       set(FEATURE_aurora_deviceintegration_drm OFF)
    endif()
    if(NOT TARGET PkgConfig::Libdrm)
        message(STATUS "You need libdrm for Aurora::DeviceIntegration::DRM")
        set(FEATURE_aurora_deviceintegration_drm OFF)
    endif()
    if(NOT TARGET PkgConfig::Gbm)
        message(STATUS "You need gbm for Aurora::DeviceIntegration::DRM")
       set(FEATURE_aurora_deviceintegration_drm OFF)
    endif()
endif()
...
if(FEATURE_aurora_deviceintegration_wayland)
    ...
    if(NOT TARGET EGL::EGL)
        message(STATUS "You need EGL for Aurora::DeviceIntegration::Wayland")
        set(FEATURE_aurora_deviceintegration_wayland OFF)
    endif()
    if(NOT TARGET Wayland::Egl)
        message(STATUS "You need Wayland::Egl for Aurora::DeviceIntegration::Wayland")
        set(FEATURE_aurora_deviceintegration_wayland OFF)
    endif()
    if(NOT KWayland_FOUND)
        message(STATUS "You need KWayland::Client for Aurora::DeviceIntegration::Wayland")
        set(FEATURE_aurora_deviceintegration_wayland OFF)
    endif()
endif()
...
if(FEATURE_aurora_xwayland)
    ...
    if(NOT X11_FOUND)
        message(STATUS "You need X11 for Aurora::XWayland")
        set(FEATURE_aurora_xwayland OFF)
    endif()
    if(NOT XCB_FOUND)
        message(STATUS "You need XCB for Aurora::XWayland")
        set(FEATURE_aurora_xwayland OFF)
    endif()
    if(NOT XKB_FOUND)
        message(STATUS "You need XKB for Aurora::XWayland")
        set(FEATURE_aurora_xwayland OFF)
    endif()
    if(NOT TARGET PkgConfig::Xcursor)
        message(STATUS "You need Xcursor for Aurora::XWayland")
        set(FEATURE_aurora_xwayland OFF)
    endif()
endif()
